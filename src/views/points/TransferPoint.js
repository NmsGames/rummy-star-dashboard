...
function TransferPoint() 
{
    ...
    return (
       ...
       <li className="nav-item">
             ...
             <Link className="nav-link " to="/ShowCurrentBet"> Strokez </Link>
</li>
          <li className="nav-item ml-3">
                         <Link className="nav-link" to="/JeetoJokerGame" >  Agent </Link>
          </li>
          <li className="nav-item ml-3">
           
             <Link className="nav-link " to="/16CardsGame"> Player </Link>
          </li>
         </ul>  
</div>
          <div className="row">
