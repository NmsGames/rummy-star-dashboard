...
function TransferPointPlayer() 
{
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      const { player_id, points, passcode } = values;
      const data = { player_id, points, pin: passcode };
      await fetch(`${apiBaseURL}/api/users/sendPlayerPoints`, {
        method: "POST",
        mode: "cors",
        headers: {
...
export default TransferPointPlayer
