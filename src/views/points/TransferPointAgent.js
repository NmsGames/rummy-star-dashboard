...
function TransferPointAgent() 
{
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      const { agent_id ,points, passcode } = values;
      const data = {  agent_id,points, pin: passcode };
      await fetch(`${apiBaseURL}/api/users/sendAgentPoints`, {
        method: "POST",
        mode: "cors",
        headers: {
...
export default TransferPointAgent
