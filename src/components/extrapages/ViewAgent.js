...
function ViewAgent() {
  ...
  const columns = [
    ...
    { title: "Balance", render: rowData =>rowData.points?rowData.points:"0.00" },
    { title: "Last Login",  render: rowData =>rowData.LastLoggedIn? moment(rowData.LastLoggedIn).format('YYYY-MM-DD h:mm:ss'):"Not login yet"  },
  ...
  return (
    <div className="content-wrapper" style={{ minHeight: "200px" ,marginLeft: "250px",transition: "margin-left .3s ease-in-out",marginBottom:"50px"}}> 
    <div className="card card-outline card-info"  >
      <MaterialTable
        ...
        actions={[
          (rowData) => {
            return {
              icon: rowData.active == 1 ? "block" : "accessibilitynow",
