...
function GameHistory() {
    ...
    const columns = [
            ...
            { title: "Win Position", render: rowData => rowData.win_no?rowData.win_no :0 },
    ...
    return (
        <div style={{ minHeight: "300px" ,marginLeft: "250px",transition: "margin-left .3s ease-in-out",marginBottom:"50px"}}>
      <MaterialTable
